...
public class utmTools {
    ...
    public static final utmItemContainer<CopperSword> COPPER_SWORD = utmItems.register("copper_sword", () -> new CopperSword(TIER_COPPER,
    ...
    public static final utmItemContainer<ShovelItem> COPPER_SHOVEL = utmItems.register("copper_shovel", () -> new ShovelItem(TIER_COPPER,
            new Item.Properties().attributes(
    ...
    public static final utmItemContainer<AxeItem> COPPER_AXE = utmItems.register("copper_axe", () -> new AxeItem(TIER_COPPER,
            new Item.Properties().attributes(
    ...
    public static final utmItemContainer<PickaxeItem> COPPER_PICKAXE = utmItems.register("copper_pickaxe", () -> new PickaxeItem(TIER_COPPER,
            new Item.Properties().attributes(
    ...
    public static final utmItemContainer<HoeItem> COPPER_HOE = utmItems.register("copper_hoe", () -> new HoeItem(TIER_COPPER,
            new Item.Properties().attributes(
    ...
    public static final utmItemContainer<FiddleheadItem> FIDDLEHEAD = utmItems.register("fiddlehead", () -> new FiddleheadItem(new Item.Properties().durability(72000)));

    public static final utmItemContainer<NetherytraItem> NETHERYTRA = utmItems.register("netherytra", () -> new NetherytraItem(new Item.Properties().durability(850).fireResistant()))
    ...
    public static final utmItemContainer<SwordItem> OBSIDIAN_SWORD = utmItems.register("obsidian_sword", () -> {
    ...
    public static final utmItemContainer<SwordItem> ENCHANTED_SWORD_RED = utmItems.register("enchanted_sword_red", () -> new SwordItem(TIER_ENCHANTED_SWORD,
            new Item.Properties().attributes(
                    SwordItem.createAttributes(TIER_ENCHANTED_SWORD, 5, -2.4f)
            ))
    ).tags(Tags.Items.ENCHANTABLES, ItemTags.SWORD_ENCHANTABLE, ItemTags.WEAPON_ENCHANTABLE, ItemTags.DURABILITY_ENCHANTABLE, ItemTags.SWORDS).handheld();

    public static final utmItemContainer<SwordItem> ENCHANTED_SWORD_GREEN = utmItems.register("enchanted_sword_green", () -> new SwordItem(TIER_ENCHANTED_SWORD,
            new Item.Properties().attributes(
                    SwordItem.createAttributes(TIER_ENCHANTED_SWORD, 5, -2.4f)
            ))
    ).tags(Tags.Items.ENCHANTABLES, ItemTags.SWORD_ENCHANTABLE, ItemTags.WEAPON_ENCHANTABLE, ItemTags.DURABILITY_ENCHANTABLE, ItemTags.SWORDS).handheld();

    public static final utmItemContainer<SwordItem> ENCHANTED_SWORD_BLUE = utmItems.register("enchanted_sword_blue", () -> new SwordItem(TIER_ENCHANTED_SWORD,
            new Item.Properties().attributes(
                    SwordItem.createAttributes(TIER_ENCHANTED_SWORD, 5, -2.4f)
            ))
    ).tags(Tags.Items.ENCHANTABLES, ItemTags.SWORD_ENCHANTABLE, ItemTags.WEAPON_ENCHANTABLE, ItemTags.DURABILITY_ENCHANTABLE, ItemTags.SWORDS).handheld();

    public static final utmItemContainer<SwordItem> CYCLESWORD = utmItems.register("cyclesword", () -> {
                var Tier = utmToolBuilder.buildTier(
    ...
    public static final utmItemContainer<AxeItem> ARID_AXE = utmItems.register("arid_axe", () -> {
                var Tier = utmToolBuilder.buildTier(
    ...
    public static final utmItemContainer<SwordItem> ARID_SWORD = utmItems.register("arid_sword", () -> {
                var Tier = utmToolBuilder.buildTier(
    ...
    public static final utmItemContainer<SwordItem> SHART = utmItems.register("shart", () -> {
                var Tier = utmToolBuilder.buildTier(
